...
public class MemberTests {
	 ...
	 * i); } else if (i < 90) { pstmt.setString(1, "manager" + i);
	 * pstmt.setString(3, "운영자" + i); } else { pstmt.setString(1, "admin" + i);
	 * pstmt.setString(3, "관리자" + i); } pstmt.executeUpdate(); } catch (Exception e)
	 * { e.printStackTrace(); } finally { if (pstmt != null) { try { pstmt.close();
	 * } catch (Exception e) { } } if (con != null) { try { con.close(); } catch
	 * (Exception e) { } } } } }
	 */
